...
describe('Angular generator', function () {
  ...
  beforeEach(function (done) {
    ...
    helpers.testDirectory(path.join(__dirname, 'temp'), function (err) {
      ...
      angular = helpers.createGenerator('angular-phonegap:app', deps);
  ...
  function generatorTest(generatorType, specType, targetDirectory, scriptNameFn, specNameFn, suffix, done) {
    ...
    angularGenerator = helpers.createGenerator('angular-phonegap:' + generatorType, deps, [name]);
  ...
  describe('View', function () {
    it('should generate a new view', function (done) {
      var angularView;
      var deps = ['../../view'];
      angularView = helpers.createGenerator('angular-phonegap:view', deps, ['foo']);
    ...
    it('should generate a new view in subdirectories', function (done) {
      var angularView;
      var deps = ['../../view'];
      angularView = helpers.createGenerator('angular-phonegap:view', deps, ['foo/bar']);
